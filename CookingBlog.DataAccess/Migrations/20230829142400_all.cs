    ...
    public partial class all : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoggEntries", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TagValue = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoggEntries_CreatedAt",
                table: "LoggEntries",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_LoggEntries_UseCaseName",
                table: "LoggEntries",
                column: "UseCaseName");

            migrationBuilder.CreateIndex(
                name: "IX_LoggEntries_Username",
                table: "LoggEntries",
                column: "Username");

            migrationBuilder.CreateIndex(
                name: "IX_Marks_BlogId",
                table: "Marks",
                column: "BlogId");
